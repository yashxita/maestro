...
export default function PodcastPage() {
  ...
  useEffect(() => {
    ...
    generateAudio(storedScript, storedFileId)
  }, [router])

  const generateAudio = async (script: string, fileId: string | null = null) => {
    setIsGeneratingAudio(true)
    setError("")

    try {
      const textToSend = fileId ? `file_id:${fileId}:${script}` : script
  ...
  return (
    <div className="min-h-screen bg-black text-white relative overflow-hidden">
      ...
      <div className="absolute inset-0 z-0  opacity-50">
        <Aurora colorStops={["#00F0FF", "#1D4ED8", "#3B82F6"]} blend={1} amplitude={1.0} speed={0.5} />
      </div>
      ...
      <div className="relative z-10 flex items-center justify-center min-h-[calc(100vh-120px)] px-8">
        <div className="w-full max-w-6xl">
          {/* Error Display */}
          {error && (
            <Alert variant="destructive" className="bg-red-900/20 border-red-500/50 mb-8">
          ...
          {isGeneratingAudio && (
            <div className="bg-slate-900/80 backdrop-blur-xl border border-slate-700/50 rounded-3xl p-12 shadow-2xl text-center">
              ...
              <h2 className="text-2xl font-semibold text-cyan-400 mb-3">Generating Your Podcast</h2>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-center">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <Slider
                      ...
                      className="flex-1"
                    />
                    <span className="text-xs text-gray-400 w-8">{playbackRate[0]}x</span>
                  </div>
                </div>
              </div>
              ...
              <div className="flex flex-col items-center space-y-8">
                <div className="relative">
                  ...
                  >
                    {/* Background circle */}
                    <circle cx="120" cy="120" r="120" stroke="rgba(255,255,255,0.1)" strokeWidth="2" fill="none" />
                    {/* Progress circle */}
                    <circle
                      cx="120"
                      cy="120"
                ...
                <div className="text-center">
                  <div className="text-2xl font-mono font-bold text-gray-300 mb-1">{formatTime(currentTime)}</div>
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-3">
                  ...
                  <Button
                    ...
                    variant="outline"
                    className="w-full bg-slate-800/50 hover:bg-slate-700/50 border-slate-800/50 hover:border-purple-400/50 transition-all"
                  >
            ...
            <div className="mt-8 bg-slate-900/80 backdrop-blur-xl border border-slate-700/50 p-6 shadow-2xl">
              <div className="flex items-center justify-between mb-6">
                <div className="flex items-center space-x-3">
                  ...
                  <h2 className="text-2xl font-semibold text-cyan-400">Podcast Script</h2>
                </div>
